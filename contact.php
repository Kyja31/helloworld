          ...
          <div class="inner cover">
            ...
            <form action="contactpost.php" method="post">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1" class="lead">Message</label>
                <textarea class="form-control" name="message" rows="5" placeholder="Ecris ton message ici..." required></textarea>
              </div>
